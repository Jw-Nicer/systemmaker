...
export function FinalCTA({
  ...
  return (
    <section
      id="get-started"
      className="relative overflow-hidden border-b border-[var(--border-light)] bg-[var(--cream-bg)] px-4 py-16 text-[var(--text-heading)] sm:px-6 sm:py-24 lg:px-10"
    >
      ...
      <div className="mx-auto max-w-6xl rounded-[var(--radius-card-lg)] border border-[#2d4632]/18 bg-[linear-gradient(180deg,#21402f,#163122)] px-5 py-10 text-center text-[#f3ecdf] shadow-[var(--shadow-elevated)] sm:rounded-[var(--radius-card-lg)] sm:px-8 sm:py-14">
        ...
        <p className="mt-8 text-xs uppercase tracking-[0.16em] text-[#b6c4b5]">{eyebrow}</p>
