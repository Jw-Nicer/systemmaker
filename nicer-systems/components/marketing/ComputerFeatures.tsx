...
const defaultFeatures: LandingFeatureItem[] = [
  {
    ...
    imageUrl: "/images/features/what-you-get-01-workflow.png",
  },
  {
    id: "02",
    ...
    imageUrl: "/images/features/what-you-get-02-kpis.png",
  },
  {
    id: "03",
  ...
  },
  {
    ...
    imageUrl: "/images/features/what-you-get-04-share.png",
  },
];
                ...
                <div className="computer-feature-visual relative min-h-[240px] rounded-[24px] sm:min-h-[280px] sm:rounded-[28px]">
                  {feature.imageUrl ? (
                    <Image
                      ...
                      alt={feature.visual}
                      fill
                      className="rounded-[24px] object-cover sm:rounded-[28px]"
